...
const Page = () => {
	return (
		<MainLayout>
			<BackgroundImageContainer bgImage="bg-prod-serv-image">
					...
					<div className="flex flex-col space-y-28 w-[90%]">
						<div className="flex flex-col space-y-10 w-full justify-center items-center">
							...
							<p className="sm:w-2/3 text-center">
								...
								plays a significant role in supporting the agricultural sector
								by{" "}
								<span className="font-medium text-lightBlue">
						...
						<div className="grid sm:grid-cols-2 grid-cols-1 gap-10 sm:px-40">
							...
							<div className="flex flex-col space-y-5">
								...
								<p>
									We are a major supplier of both yellow and white maize, a
									staple food crop in South Africa and internationally. Sourced
									from reputable farms, our maize consistently meets the highest
