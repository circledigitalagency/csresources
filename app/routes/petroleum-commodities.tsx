...
const Page = () => {
	return (
		<MainLayout>
			<BackgroundImageContainer bgImage="bg-prod-serv-image py-28">
					...
					<div className="flex flex-col space-y-28 w-[90%]">
						...
						<div className="grid sm:grid-cols-2 grid-cols-1 gap-10 sm:px-40">
							...
							<div className="flex flex-col space-y-5">
								...
								<p>
									...
									from construction and mining to agriculture and
									transportation, and it forms the core of our petroleum
									offering. We supply only the highest-quality bulk diesel that
									meets all South African Bureau of Standards (SABS)
									requirements and industry standards, ensuring reliability and
									optimal performance in all modern diesel engines.
								</p>
						...
						<div className="grid sm:grid-cols-2 grid-cols-1 gap-10 sm:px-40">
							...
							<div className="flex flex-col space-y-5">
								...
								<p>
									Our range includes high-quality lubricants and oils designed
									for vehicles, machinery, and various industrial equipment.
								</p>
							</div>
							<img
								src="/assets/oils-lubricants.jpg"
						...
						<div className="grid sm:grid-cols-2 grid-cols-1 gap-10 sm:px-40">
							<img
								src="/assets/quality-assurance.jpg"
							...
							<div className="flex flex-col space-y-5">
								...
								<p>
									We focus on providing premium-quality petroleum products
									sourced exclusively from trusted suppliers. Our commitment
									ensures that customers receive products meeting stringent
